...
export const articles: Article[] = [
  ...
  // Kemikaliefri städning
  {
    ...
    title: 'Bikarbonat städning: komplett guide för hela hemmet',
    excerpt: 'Bikarbonat skurar, luktneutraliserar och löser upp fett i ugn, badrum och kylskåp. Komplett guide med kemisk förklaring, kombinationer med ättika och köptips.',
    category: 'Kemikaliefri städning',
    categoryUrl: '/kemikaliefri-stadning/',
    hero: '/images/heroes/bikarbonat-stadning.webp',
  ...
  },
  {
    ...
    category: 'Rengöring av apparater',
    categoryUrl: '/rengoring-av-apparater/',
    hero: '/images/heroes/rengora-kylskap.webp',
    publishDate: '2026-04-29',
    readingTime: 6,
    published: true,
  },
  ...
  // Allergi & astma, ny
  {
    ...
    category: 'Allergi & astma',
    categoryUrl: '/allergi-och-astma/',
    hero: '/images/heroes/husdjursallergen-i-hemmet.webp',
  ...
  // Kemikaliefri städning, ny
  {
    ...
    category: 'Kemikaliefri städning',
    categoryUrl: '/kemikaliefri-stadning/',
    hero: '/images/heroes/gora-eget-allrengoringsmedel.webp',
    publishDate: '2026-04-30',
    updateDate: '2026-04-30',
    readingTime: 8,
    published: true,
  ...
  // Mögel & fukt, ny
  {
    ...
    category: 'Mögel & fukt',
    categoryUrl: '/mogel-och-fukt/',
    hero: '/images/heroes/avfuktare-hemmet.webp',
    publishDate: '2026-04-30',
    updateDate: '2026-04-30',
    readingTime: 9,
    published: true,
  ...
  // Inomhusluft, ny
  {
    ...
    category: 'Inomhusluft',
    categoryUrl: '/inomhusluft/',
    hero: '/images/heroes/koldioxid-inomhus.webp',
    publishDate: '2026-04-30',
    updateDate: '2026-04-30',
    readingTime: 8,
    published: true,
  ...
  // Inomhusluft, VOC (2026-05-08)
  {
    ...
    category: 'Inomhusluft',
    categoryUrl: '/inomhusluft/',
    hero: '/images/heroes/voc-inomhus.webp',
  ...
  // Rengöring av apparater, ny
  {
    ...
    category: 'Rengöring av apparater',
    categoryUrl: '/rengoring-av-apparater/',
    hero: '/images/heroes/rengora-mikrovagen.webp',
    publishDate: '2026-04-30',
    updateDate: '2026-04-30',
    readingTime: 6,
    published: true,
  ...
  // Städtips & rutiner, ny
  {
    ...
    category: 'Städtips & rutiner',
    categoryUrl: '/stadtips-och-rutiner/',
    hero: '/images/heroes/rengora-badrum.webp',
    publishDate: '2026-04-30',
    updateDate: '2026-04-30',
    readingTime: 7,
    published: true,
  ...
  // Kök & hygien
  {
    ...
    hero: '/images/heroes/rengora-ugnen.webp',
    publishDate: '2026-04-30',
    updateDate: '2026-04-30',
    readingTime: 7,
    cornerstone: true,
  ...
  },
  {
    ...
    category: 'Kök & hygien',
    categoryUrl: '/kok-och-hygien/',
    hero: '/images/heroes/desinfektera-skanbrader.webp',
    publishDate: '2026-04-30',
    readingTime: 6,
    published: true,
  },
  {
    ...
    category: 'Kök & hygien',
    categoryUrl: '/kok-och-hygien/',
    hero: '/images/heroes/rengora-spisflaknten.webp',
    publishDate: '2026-04-30',
    readingTime: 6,
    published: true,
  },
